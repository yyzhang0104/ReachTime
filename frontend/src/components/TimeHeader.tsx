    ...
    <>
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800 tracking-tight">GlobalSync</h1>
            <p className="text-xs font-medium text-slate-500 uppercase tracking-widest">Global CRM Assistant</p>
          </div>
        </div>
              ...
              <div className="p-4 overflow-y-auto max-h-[60vh]">
                ...
                {isAway && (
                  <button
                    ...
                    className="w-full mb-4 p-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-medium rounded-xl flex items-center gap-3 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
